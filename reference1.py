...
html = urllib.request.urlopen('https://book.douban.com/series/32479?page=1', context=context)
bsObj = BeautifulSoup(html, 'lxml')
# 这里的 range（初始，结束，间隔）
for i in range(1,14):
    # urllib.request库用来向该网服务器发送请求，请求打开该网址链接
    html = urllib.request.urlopen('https://book.douban.com/series/32479?page=%d' % i, context=context)
